...
//	#define AREA_Y_DEF  (CONSOLE_LOG_VIEW_AREA_Y-OFFSET_HEIGHT)
	#define AREA_Y_DEF  (CONSOLE_LOG_VIEW_AREA_Y)
        #define AREA_Y      (CONSOLE_LOG_VIEW_AREA_Y) 
//        #define AREA_Y      (CONSOLE_LOG_VIEW_AREA_Y+offset_height) 
	#define AREA_W      (CONSOLE_LOG_VIEW_AREA_WIDTH)
//	#define AREA_H      (CONSOLE_LOG_VIEW_AREA_HEIGHT+offset_height)
