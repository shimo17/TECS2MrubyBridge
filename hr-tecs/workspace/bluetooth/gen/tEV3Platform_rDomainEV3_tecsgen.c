...
tEV3Platform_INIB tEV3Platform_INIB_tab[] = {
    ...
    {
        /* call port #_CP_# */ 
        rDomainEV3_EV3Platform_cRiteVM,          /* #_CCP3_# */
        1,                                       /* length of cRiteVM (n_cRiteVM) #_CCP4_# */
        rDomainEV3_EV3Platform_cTask,            /* #_CCP3_# */
        1,                                       /* length of cTask (n_cTask) #_CCP4_# */
        /* entry port #_EP_# */ 
    },
};
