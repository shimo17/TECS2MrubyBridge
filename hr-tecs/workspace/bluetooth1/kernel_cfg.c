...
const ID _kernel_torder_table[TNUM_STSKID] = {
	LOGTASK, BRICK_BTN_TSK, LCD_REFRESH_TSK, CONSOLE_BTN_TSK, BT_TSK, BT_QOS_TSK, EV3_INIT_TASK, PLATFORM_BUSY_TASK, APP_INIT_TASK, TSKID_tTask_Task, ZMODEM_RECV_TASK
};
