...
const TINIB _kernel_tinib_table[TNUM_STSKID] = {
	...
	{ &_kernel_dominib_kernel, (TA_ACT), (intptr_t)(1), ((TASK)(tTask_start_task)), INT_PRIORITY(EV3_MRUBY_VM_PRIORITY), ROUND_STK_T(STACK_SIZE), _kernel_sstack_TSKID_tTask_MrubyTask1, 0, NULL, (TA_NULL), (tTask_start_exception), { TACP_KERNEL, TACP_KERNEL, TACP_KERNEL, TACP_KERNEL }}
};
...
const ID _kernel_torder_table[TNUM_STSKID] = {
	LOGTASK, BRICK_BTN_TSK, LCD_REFRESH_TSK, CONSOLE_BTN_TSK, BT_TSK, BT_QOS_TSK, EV3_INIT_TASK, PLATFORM_BUSY_TASK, APP_INIT_TASK, TSKID_tTask_EV3Task, TSKID_tTask_MrubyTask1
};
